...
class Rectangle:
    ...
    # using Static Method to compare the area of 2 Rectangle instances
    ...
    # using Class method to return new Rectangle instance
    ...
    def square(cls, size=0):
        ...
        Args:
            size (int): the size of the sides of the Rectangle (default 0)
        """
